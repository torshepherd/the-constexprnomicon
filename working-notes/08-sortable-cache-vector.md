...
The selected [advanced source](../advanced/cache-vector.cpp) stands alone. The
...
```sh
g++ -std=c++23 -O0 -fconstexpr-cache-depth=64 -fmax-errors=2 -c advanced/cache-vector.cpp -o /tmp/advanced-cache-vector-O0.o
g++ -std=c++23 -O2 -fconstexpr-cache-depth=64 -fmax-errors=2 -c advanced/cache-vector.cpp -o /tmp/advanced-cache-vector-O2.o
```
