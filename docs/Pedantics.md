...
- The earlier affirmative assessment of the copy-driven factorial is withdrawn
  ...
  results still stand. See the [corrected assessment](../.agents/notes/09-copy-gate.md#roughly-turing-assessment).
...
The “secret equality” [research direction](../.agents/notes/09-copy-gate.md#follow-up-the-compilers-secret-equality)
