...
rules remain in [Pedantics.md](../../docs/Pedantics.md).
...
[Pedantics.md](../../docs/Pedantics.md); [MACHINES.md](../../docs/MACHINES.md) is now the reader-facing
...
1. Read the short [root spell](../../tricks/false-idols/false-idols.cpp), then the reduction in note 12.
