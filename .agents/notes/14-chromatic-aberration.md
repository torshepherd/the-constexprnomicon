...
The [root spell](../../tricks/chromatic-aberration/chromatic-aberration.cpp) demonstrates a five-cycle.
The [reader walkthrough](../../tricks/chromatic-aberration/README.md) builds the coloring example
from dots, lines, and empty-object addresses without assuming graph theory.
[Layout controls](../../tricks/chromatic-aberration/experiments/layout-controls.cpp) check order dependence and the effect of
ordinary members. [The graph checker](../../tricks/chromatic-aberration/experiments/layout-check.py) compares against a
separate implementation. [The XOR probe](../../tricks/chromatic-aberration/experiments/layout-xor.cpp) preserves the finite
...
[Tor's criteria](../../docs/Pedantics.md). All gates are spelled out in a finite class;
...
```sh
g++ -std=c++20 -O0 -Wall -Wextra -pedantic-errors -fsyntax-only tricks/chromatic-aberration/chromatic-aberration.cpp tricks/chromatic-aberration/experiments/layout-controls.cpp tricks/chromatic-aberration/experiments/layout-xor.cpp
g++ -std=c++20 -O2 -Wall -Wextra -pedantic-errors -fsyntax-only tricks/chromatic-aberration/chromatic-aberration.cpp tricks/chromatic-aberration/experiments/layout-controls.cpp tricks/chromatic-aberration/experiments/layout-xor.cpp
python3 tricks/chromatic-aberration/experiments/layout-check.py
python3 tricks/chromatic-aberration/experiments/layout-check.py --small --source > /tmp/layout-subset.cpp
```
...
The walkthrough is now [chromatic-aberration.md](../../tricks/chromatic-aberration/README.md),
