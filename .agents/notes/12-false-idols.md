...
The [standalone example](../../tricks/false-idols/false-idols.cpp) includes a satisfiable control.
[Additional controls](../../tricks/false-idols/experiments/subsumption-controls.cpp) check the structural information
channel and the guard. The [regression generator](../../tricks/false-idols/experiments/false-idols-check.py) checks
...
```sh
g++ -std=c++20 -Wall -Wextra -pedantic-errors -fsyntax-only tricks/false-idols/false-idols.cpp
g++ -std=c++20 -O0 -fconstexpr-depth=1 -fconstexpr-ops-limit=16 -ftemplate-depth=8 -fsyntax-only tricks/false-idols/experiments/subsumption-controls.cpp
python3 tricks/false-idols/experiments/false-idols-check.py
```
