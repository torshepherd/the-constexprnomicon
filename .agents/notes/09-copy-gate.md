...
tabled pointer work alone. The selected [copy gate](../../tricks/copy-gate/copy-gate.cpp) explores
...
```sh
g++ -std=c++23 -O0 -Wall -Wextra -pedantic-errors -fmax-errors=2 -c tricks/copy-gate/copy-gate.cpp -o /tmp/copy-gate-O0.o
g++ -std=c++23 -O2 -Wall -Wextra -pedantic-errors -fmax-errors=2 -c tricks/copy-gate/copy-gate.cpp -o /tmp/copy-gate-O2.o
g++ -std=c++23 -O2 -fconstexpr-cache-depth=0 -Wall -Wextra -pedantic-errors -fmax-errors=2 -c tricks/copy-gate/copy-gate.cpp -o /tmp/copy-gate-no-cache.o
```
...
Apply Tor's [Pedantics](../../docs/Pedantics.md) when choosing the allowed operations for
...
instructions for applying it are preserved verbatim in [Pedantics.md](../../docs/Pedantics.md).
...
win under [Pedantics.md](../../docs/Pedantics.md); see the corrected assessment above.
